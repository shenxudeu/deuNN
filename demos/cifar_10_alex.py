...
from deuNet.layers.batch_normalization import LRN2D
...
model.add(Convolution2D(96,3,11,11, border_mode='valid',subsample=(4,4),
    init='glorot_uniform',activation='relu', reg_W=reg_W))  
nh, nw = valid(32,32,11,4)
model.add(LRN2D())
...
model.add(Flatten())
model.add(AffineLayer(96*nh*nw, 512,activation='relu',reg_W=reg_W, init='glorot_uniform'))
