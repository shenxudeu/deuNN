...
checkpoint_fn = '.trained_mnist_vgg.h5'
...
model.add(Convolution2D(64,1, 3,3, border_mode='full', init='normal',activation='relu', reg_W=0, w_scale=0.01))
model.add(Convolution2D(64,64,3,3, border_mode='full', init='normal',activation='relu', reg_W=0, w_scale=0.01))
model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Dropout(0.2, uncertainty=False))

model.add(Convolution2D(128,64,3,3, border_mode='full', init='normal',activation='relu', reg_W=0, w_scale=0.01))
model.add(Convolution2D(128,128,3,3, border_mode='full', init='normal',activation='relu', reg_W=0, w_scale=0.01))
model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Dropout(0.5, uncertainty=False))

model.add(Convolution2D(256,128,3,3, border_mode='full', init='normal',activation='relu', reg_W=0, w_scale=0.01))
model.add(Convolution2D(256,256,3,3, border_mode='full', init='normal',activation='relu', reg_W=0, w_scale=0.01))
model.add(Convolution2D(256,256,3,3, border_mode='full', init='normal',activation='relu', reg_W=0, w_scale=0.01))
model.add(MaxPooling2D(pool_size=(2,2)))
model.add(Dropout(0.5, uncertainty=False))
