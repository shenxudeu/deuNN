...
def model(X, w, w4, w_o, p_drop_conv, p_drop_hidden):
    l1a = rectify(conv2d(X, w, border_mode = 'valid'))
    l1  = max_pool_2d(l1a, (2,2))
    l1  = T.flatten(l1, outdim=2)
...
w4 = init_weights((8*13*13,5))
w_o = init_weights((5,10))

noise_l1, noise_l4, noise_py_x = model(X,w,w4,w_o,0.2,0.5)
l1,l4,py_x = model(X,w,w4,w_o,0,0)
